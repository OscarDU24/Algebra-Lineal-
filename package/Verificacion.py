"""
Comprueba la solución obtenida sustituyendo los valores de las variables
en el sistema ORIGINAL (antes de la eliminación) y verificando la igualdad
...
def verificar_solucion(A_original, b_original, x, m, n, tolerancia=1e-6):
    """
    Sustituye los valores de x en cada ecuación original y muestra el
    resultado comparado contra el término independiente esperado.
    """
